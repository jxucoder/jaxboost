...
def qwk_metric(n_classes: int, transform: Callable[[np.ndarray], np.ndarray] | None = None) -> Metric:
    """
...
def ordinal_mae_metric(n_classes: int, transform: Callable[[np.ndarray], np.ndarray] | None = None) -> Metric:
    """
...
def ordinal_accuracy_metric(n_classes: int, transform: Callable[[np.ndarray], np.ndarray] | None = None) -> Metric:
    """
...
def adjacent_accuracy_metric(n_classes: int, transform: Callable[[np.ndarray], np.ndarray] | None = None) -> Metric:
    """
